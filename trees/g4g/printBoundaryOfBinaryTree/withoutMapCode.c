...
void printLeftEdge(strut tree_node *root) {
...
void printRightEdge(struct tree_node *root) {



}

void printLeaves(struct tree_node *root) {
...
void printBoundaryOfBinaryTree(struct tree_node *root) {
